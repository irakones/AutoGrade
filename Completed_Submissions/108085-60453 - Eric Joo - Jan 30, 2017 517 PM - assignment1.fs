...
(* Student name: Eric Joo, Id Number: 260629236 *) (* Edit this line. *)
...
let rec selsort l =
    match l with
        ...
        | x::xs ->
            ...
            if (x = largestElement) then x::selsort(remove(x,xs))
            else largestElement::selsort(remove(largestElement, l))
