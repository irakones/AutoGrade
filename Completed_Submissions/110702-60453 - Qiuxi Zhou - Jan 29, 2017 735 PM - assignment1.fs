...
(* Student name: QIUXI ZHOU, Id Number: 260627706 *) (* Edit this line. *)
...
let w_mean weights data = 
  let sum = sumlist weights
  let newlist = pairlists (weights,data)
  let rec add newlist = 
    match newlist with
      | [] -> 0.0
      | (a,b)::xs -> a*b+ add xs
